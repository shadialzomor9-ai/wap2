...
const AboutSection = () => {
  ...
  const infoCards = [{
    ...
    logos: [{
      name: "ديب روت للاستشارات",
      src: "https://rowad.org/public/deep.png",
      alt: "DeepRoot"
    }, {
      name: "مؤسسة روّاد الاعمال",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        delay: 0.2
          ...
          <div className="bg-card/50 backdrop-blur-sm rounded-2xl p-8 border border-border/50 glow-border">
            <p className="text-lg md:text-xl leading-relaxed text-foreground/90 mb-6">مسرّعة الأعمال وثبة هو أحد مكونات برنامج وثبة الممول من بعثة الإتحاد الأوروبي لدى اليمن ومجموعة هائل سعيد أنعم وشركاه وتُنفذه مؤسسة روّاد الأعمال بالشراكة مع ديب رووت للاستشارات.</p>
