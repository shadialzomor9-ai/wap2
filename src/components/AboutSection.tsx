  ...
  const infoCards = [
    {
      icon: Building2,
      title: "الممولون",
      desc: "الإتحاد الأوروبي ومجموعة هائل سعيد أنعم",
    },
    {
      icon: Calendar,
      title: "المدة",
        ...
        >
          <div className="bg-card/50 backdrop-blur-sm rounded-2xl p-8 border border-border/50 glow-border">
            <p className="text-lg md:text-xl leading-relaxed text-foreground/90 mb-6">
              مسرّعة الأعمال وثبة هو أحد مكونات برنامج وثبة الممول من الإتحاد الأوروبي ومجموعة هائل سعيد أنعم ويُنفذه مؤسسة روّاد الأعمال بالشراكة مع ديب رووت للاستشارات.
            </p>
