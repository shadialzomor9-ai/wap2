...
const HeroSection = ({
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(20)].map((_, i) => <motion.div key={i} className="absolute w-1 h-1 rounded-full bg-primary/30" style={{
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96">
        ...
        ease: "linear"
          ...
          <div className="w-3 h-3 rounded-full bg-primary glow-primary" style={{
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          duration: 0.6,
          delay: 0.4
        }} className="text-xl md:text-2xl text-muted-foreground mb-12 leading-relaxed">انطلق نحو النجاح مع برنامج تسريع الأعمال للشركات الناشئة في اليمن</motion.p>
          ...
          {/* CTA Button */}
          <motion.a href={applicationUrl} initial={{
          opacity: 0,
          scale: 0.8
        }} animate={{
          opacity: 1,
