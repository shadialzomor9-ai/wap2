...
const ObjectivesSection = () => {
  ...
  const objectives = [
    ...
    {
      icon: Leaf,
      text: "توسيع الشبكات والعلاقات:\nتمكين الشركات من بناء علاقات مع شركاء محتملين، عملاء، مستثمرين، ومؤسسات داعمة ضمن منظومة ريادة الأعمال",
      color: "from-accent to-primary",
    },
    {
      icon: UserCircle,
      text: "بناء القدرات الريادية للمؤسسين ورفع الجاهزية الاستثمارية لشركاتهم:\nرفع كفاءة المؤسسين في مجالات مثل الإدارة، التسويق، التمويل، القيادة، وبناء الفرق.",
      color: "from-primary to-accent",
    },
    {
      icon: TrendingUp,
      text: "زيادة فرص الاستدامة والتوسع:\nمساعدة الشركات على وضع خطط واضحة للنمو، والتوسع في الأسواق، وتحقيق الاستدامة المالية.",
      color: "from-accent to-primary",
    },
  ];
