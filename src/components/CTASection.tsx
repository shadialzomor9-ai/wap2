...
const CTASection = ({
  ...
  return <section className="relative py-[65px]" ref={ref}>
      <div className="container mx-auto px-4 relative z-10">
        ...
        duration: 0.6
          ...
          <div className="relative bg-gradient-to-br from-primary/20 via-card to-accent/20 rounded-3xl p-12 md:p-16 border border-primary/30 overflow-hidden">
            ...
            <motion.div className="absolute top-10 right-10 w-20 h-20 rounded-full bg-primary/10 blur-xl" animate={{
            scale: [1, 1.2, 1],
            opacity: [0.3, 0.5, 0.3]
          }} transition={{
            duration: 3,
            ...
            <motion.div className="absolute bottom-10 left-10 w-32 h-32 rounded-full bg-accent/10 blur-xl" animate={{
            scale: [1, 1.3, 1],
            opacity: [0.2, 0.4, 0.2]
          }} transition={{
            duration: 4,
