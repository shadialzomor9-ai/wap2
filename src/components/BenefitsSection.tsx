  ...
  const benefits = [
    {
      ...
      content: "سيحصل المؤسسون على إرشادات قيّمة من مرشدين متخصصين دوليين واستشاريين محليين في مختلف المجالات لمساعدتك على اتخاذ القرارات الصحيحة وتجنب الأخطاء الشائعة.",
    },
    {
      icon: GraduationCap,
      title: "برامج تدريبية متقدمة",
      content: "سيُزود المؤسسون بمهارات رفع الجاهزية الاستثمارية والمعرفة اللازمة لتطوير نموذج عمل شركاتهم، وتحسين استراتيجيات التسويق والمبيعات، وإدارة الشؤون المالية بكفاءة،.",
    },
    {
      icon: Users,
      title: "فرص للوصول للمستثمرين",
      content: "سنعمل على انشاء قنوات تواصل مع شبكة واسعة من المستثمرين المحتملين ورجال وسيدات الاعمال.",
    },
    {
      icon: Banknote,
      title: "منح مالية",
      content: "دعم مالي لتنفيذ خطط النمو والتوسع.",
    },
    {
      icon: Wrench,
      title: "مساعدة فنية",
      content: "تعزيز جاهزية الشركات الناشئة للاستثمار.",
    },
  ];
