  ...
  const benefits = [
    {
      ...
      content: "ستحصل على إرشادات قيّمة من مرشدين متخصصين دوليين و استشاريين محليين في مختلف المجالات لمساعدتك على اتخاذ القرارات الصحيحة وتجنب الأخطاء الشائعة.",
    },
    {
      icon: GraduationCap,
